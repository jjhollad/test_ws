...
def launch_setup(context, *args, **kwargs):
    ...
    create_bringup_dir = os.path.join(get_package_share_directory('create_bringup'))
    sensors_dir = os.path.join(get_package_share_directory('create3_lidar_slam'))
    slam_toolbox_dir = os.path.join(get_package_share_directory('create3_lidar_slam'))
    ...
    create_bringup_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(create_bringup_dir, 'create_2.launch.py')
        )
    )
