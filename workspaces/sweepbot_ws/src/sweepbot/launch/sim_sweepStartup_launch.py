...
def launch_setup(context, *args, **kwargs):
    ...
    x_pose = LaunchConfiguration('x_pose', default='-1.90')
    y_pose = LaunchConfiguration('y_pose', default='-0.62')
...
#       'map': os.path.join(nav2_file_dir, 'map', 'map.yaml'),
 	    'map': os.path.join(os.path.expanduser('~'), 'sweepbot_ws', 'map', 'my_map.yaml'),
