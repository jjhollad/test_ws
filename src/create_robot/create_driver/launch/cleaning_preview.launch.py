...
DEFAULT_COVERAGE_CSV_PATH = '/home/user/test_ws/opencv_fullsb_main_square_preview/center_loop_path.csv'
...
def generate_launch_description():
    ...
    coverage_csv_path_arg = DeclareLaunchArgument(
        'coverage_csv_path',
        default_value=DEFAULT_COVERAGE_CSV_PATH,
    ...
    require_coverage_csv_arg = DeclareLaunchArgument(
        ...
        default_value='true',
        description='Require OpenCV-generated coverage CSV; set false to allow legacy /map preview',
    )
    coverage_algorithm_arg = DeclareLaunchArgument(
        'coverage_algorithm',
        default_value='center_loop',
        description='Legacy /map fallback algorithm used only when require_coverage_csv is false',
    )
